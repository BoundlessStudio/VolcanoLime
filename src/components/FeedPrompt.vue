...
<template>
  ...
  <div v-if="show==1" class="py-3 h-28">
    <div @click="recording" class="p-3 flex rounded-md text-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 bg-gray-100 cursor-pointer">
  ...
  <div v-if="show==2" class="py-3 h-28">
    <div ref="dropZoneRef" class="p-3 flex rounded-md text-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 bg-gray-100">
      ...
      <div class="flex-grow flex justify-end py-4">
        <button @click="choiceFile" type="button" class="rounded bg-indigo-400 px-4 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Choose file</button>
      </div>
    </div>
  </div>
    ...
    <div class="p-3 flex rounded-md text-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 bg-gray-100">
      ...
      <div class="w-full flex space-x-2 px-2">
        <div class="w-full">
          ...
          <input v-model="imageUrl" type="input" name="url-image" id="url-image" class="block w-full rounded-md border-0 px-1 py-1.5 mt-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="url" />
        </div>
        <div class="w-full">
          <label for="description-image" class="sr-only">Description</label>
          <input v-model="imageDescription" type="input" name="description-image" id="escription-image" class="block w-full rounded-md border-0 px-1 py-1.5 mt-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="description (optional)" />
        </div>
      </div>
      <div class="flex-grow flex justify-end py-1">
        <button @click="submitImage" type="button" class="rounded bg-indigo-400 px-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
  ...
  <div v-if="show==4" class="py-3 h-28">
    <div class="p-3 flex rounded-md text-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 bg-gray-100">
      ...
      <div class="w-full flex space-x-2 px-2">
        <div class="w-full">
          <label for="url-image" class="sr-only">Url</label>
          <input v-model="linkUrl" type="input" name="url-image" id="url-image" class="block w-full rounded-md border-0 px-1 py-1.5 mt-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="url" />
        </div>
        <div class="w-full">
          <label for="description-image" class="sr-only">Description</label>
          <input v-model="linkDescription"  type="input" name="description-image" id="escription-image" class="block w-full rounded-md border-0 px-1 py-1.5 mt-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="description (optional)" />
        </div>
      </div>
      <div class="flex-grow flex justify-end py-1">
        <button @click="submitLink" type="button" class="rounded bg-indigo-400 px-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          <font-awesome-icon icon="add" />
        </button>
      </div>
    </div>
