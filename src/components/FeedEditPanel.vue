                        ...
                        <div class="pb-5 pt-6">
                          <TabGroup>
                            <TabList class="space-x-2">
                              <Tab v-slot="{ selected }">
                                <button
                                  v-if="selected"
                                  type="button"
                                  class="rounded bg-lime-500 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-lime-500"
                                >
                                  General
                                </button>
                                <button
                                  v-else
                                  type="button"
                                  class="rounded bg-lime-600 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-lime-500"
                                >
                                  General
                                </button>
                              </Tab>
                            ...
                            <TabPanels>
                              <TabPanel>
                                <div
                                  class="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-2 sm:space-y-0 sm:px-6 sm:py-5"
                                >
                                  <div>
                                    <label
                                      for="project-name"
                                      ...
                                      <li>
                                        <div class="relative flex items-start">
                                          <div class="flex h-6 items-center">
                                            <input
                                              v-model="document.selectedSkills"
                                              :id="skill.skillId"
                                              :value="skill.skillId"
                                              type="checkbox"
                              ...
                              <TabPanel>
                                <fieldset
                                  class="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-2 sm:space-y-0 sm:px-6 sm:py-5"
                                >
                                      ...
                                      <div class="relative flex items-start">
                                        ...
                                        <div class="pl-7 text-sm leading-6">
                                          ...
                                          <p id="private-access-description" class="text-gray-500">
                                            You are the only one able to access this feed
                                          </p>
                                        </div>
                                      </div>
                                      <div class="relative flex items-start">
                                        ...
                                        <div class="pl-7 text-sm leading-6">
                                          ...
                                          <p id="public-access-description" class="text-gray-500">
                                            Everyone with the link will see this feed
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div>
                                      ...
                                      >
                                        <font-awesome-icon
                                          ...
                                          aria-hidden="true"
                                        />
                                        <a href="/about#sharing" target="_blank"
