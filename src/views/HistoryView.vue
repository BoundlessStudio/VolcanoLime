        ...
        <div class="flex w-full items-center justify-between space-x-6 p-6">
          <div class="flex-1 truncate">
            <div class="flex items-center space-x-3">
              ...
              <span
                v-if="feed.access == FeedAccess.Public"
                class="inline-flex flex-shrink-0 items-center rounded-full bg-indigo-50 px-1.5 py-0.5 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-600/20"
              >
        ...
        <div>
          <div class="-mt-px flex divide-x divide-gray-200">
            ...
            <div class="-ml-px flex w-0 flex-1">
              <a
                @click="confirmation = feed.feedId"
                href="#"
