...
import type { AnswerMessage, ChatMessage, PlanMessage, Thread } from '@/types/thread'
...
const data = [
    ...
    } as ChatMessage,
    {
      ...
      citations: [
        {
          id: uuidv4(),
          text: "1 - Northwind_Health_Plus_Benfits_Details-70.pdf"
        }
      ],
      followup: [
